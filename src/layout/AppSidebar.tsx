...
/** Products as a plain link for non-admins (no attribute management). */
...
/** Admins get Products as a submenu with the global attribute pool under it. */
const productAdminItem: NavItem = {
  icon: <BoxIcon />,
  name: "Product",
  subItems: [
